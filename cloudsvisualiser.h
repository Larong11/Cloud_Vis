...
public:
    ...
    void updateCloudPosXYZ(int index);
    void resizeCloudXYZ(int index, int scheme);
    ...
    void updateCloudPosXYZI(int index);
    void resizeCloudXYZI(int index, int scheme);
    ...
    void updateCloudPosXYZRGB(int index);
    void resizeCloudXYZRGB(int index, int scheme);
